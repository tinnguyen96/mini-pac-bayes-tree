...
classifer_name = "PDDT_" + penalty_type
...
if (train_index == 4):
    ...
    filename = 'MD/each experiment, each train size/' + dataset_name + '-' + classifer_name + '-ex' + str(ex_index)+'tr'+str(train_index)+'.npy'
