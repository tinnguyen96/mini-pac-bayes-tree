...
# -
# 
# Details that might need revision later
# - if a point lies exactly on the threshold, set the point to belong to the left node  
#
# Current bugs:
# 
...
class DDT:
    ...
    def __update_penalty(self, node):
        ...
        if (exCount > 0):
            if (self._penaltyType == "effInt"):
                penalty = 1/float(self._trainSize)
            elif (self._penaltyType == "ada"):
